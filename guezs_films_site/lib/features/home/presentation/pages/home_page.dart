        ...
        children: [
          Transform.translate(
            ...
            child: CachedImage(
              ...
              alignment: film.title == 'Elle et moi' ? Alignment.topCenter : Alignment.center,
            ),
          ),
          Container(
            decoration: BoxDecoration(
        ...
        children: [
          Transform.translate(
            ...
            child: CachedImage(
              ...
              height: screenHeight * 0.52 + 100,
              borderRadius: BorderRadius.zero,
              alignment: series.title == 'Elle et moi' ? Alignment.topCenter : Alignment.center,
            ),
          ),
          Container(
            decoration: BoxDecoration(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Icon(CupertinoIcons.bell_fill, color: AppColors.accentSoft, size: 18),
              const SizedBox(width: 8),
              Text(
                'Notifications',
            ...
            child: ListView(
              ...
              children: [
                ...
                _NotificationCard(
                  ...
                  body: 'Nous sommes ravis de vous accueillir sur Guezs Films. '
                ...
                _NotificationCard(
                  ...
                  body: 'La série tant attendue "La femme du Mbenguiste" '
                      'débarque le 06 Juin sur Guezs Films. Restez connectés !',
                  time: 'Aujourd\'hui',
                  isNew: true,
                ).animate(delay: 150.ms).fadeIn(duration: 400.ms).slideX(begin: -0.05, end: 0),
