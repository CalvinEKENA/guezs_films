class AuthErrorMapper {
  ...
  static String map(String code, [String? originalMessage]) {
    // Si le message original contient des erreurs JS spécifiques au Web
    if (originalMessage != null && originalMessage.contains('JSObject')) {
      return "Une erreur technique s'est produite avec le navigateur. Veuillez rafraîchir la page.";
    }
