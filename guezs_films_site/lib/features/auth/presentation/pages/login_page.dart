...
import 'package:guezs_films_site/core/theme/app_colors.dart';
import 'package:guezs_films_site/core/theme/app_text_styles.dart';
import 'package:guezs_films_site/core/widgets/gradient_button.dart';
import 'package:guezs_films_site/core/widgets/glass_card.dart';
...
class _LoginPageState extends ConsumerState<LoginPage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (authState is AsyncError) {
      ...
      if (errorStr.contains('192.168.100.203') || errorStr.contains('redirect_uri_mismatch')) {
        helperMessage = "⚙️ Configuration : Ajoutez l'IP 192.168.100.203 dans les domaines autorisés de votre console Firebase.";
      }
    }
