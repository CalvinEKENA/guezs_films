...
class ProfileSelectorPage extends ConsumerWidget {
  ...
  Widget _buildContent(
    ...
    final String prompt = Uri.encodeComponent(
      'A beautiful light-skinned African woman with longer hair, sad, dramatic look, slightly black and white, classic movie image style, cinematic portrait',
    );
    final String posterUrl =
        'https://image.pollinations.ai/prompt/$prompt?width=1200&height=1800&nologo=true';
    ...
    return Wrap(
      ...
      children: allItems.map((item) {
        ...
        return widget
            .animate()
            .fadeIn(
              delay: Duration(milliseconds: 500 + (80 * index)),
              duration: 350.ms,
            )
